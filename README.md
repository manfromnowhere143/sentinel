...
same frozen target rows. No calibration, heldout, iteration-12, selector, GPU, or closed-loop work
is authorized from iter31 or iter32. A successor requires a fresh prefix-preserving intervention
pre-registration:
