...
| [`experiments/iter24_risk_support_atlas/`](experiments/iter24_risk_support_atlas) | fresh risk-support atlas — active pre-registration; no data, GPU, probes, interventions, iter12, or closed loop launched |
