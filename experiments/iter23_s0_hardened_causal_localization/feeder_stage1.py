#!/usr/bin/env python3
"""Manifest-driven feeder for iteration-23 canary/full extraction.
...
def main():
    ...
    ap.add_argument("--out", default="/model/sentinel_e23_stage1_gt.jsonl")
    args = ap.parse_args()
    ...
    for sc in ordered_scenes:
        ...
        for sample_index, smp in enumerate(chain):
            ...
            t0 = time.time()
            post(f"{base}/sentinel_e23_context", context)
