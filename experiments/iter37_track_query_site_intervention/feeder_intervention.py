#!/usr/bin/env python3
"""Prefix-preserving feeder for iteration-37 track-query intervention replay."""
...
def main():
    ...
    ap.add_argument("--prefix-manifest", default="/model/prefix_manifest_iter37.json")
    ...
    ap.add_argument("--out", default="/model/sentinel_e37_gt.jsonl")
    args = ap.parse_args()
    ...
    for sc in ordered_scenes:
        ...
        for sample_index, smp in enumerate(chain):
            ...
            t0 = time.time()
            post(f"{base}/sentinel_e37_context", context)
