#!/usr/bin/env python3
"""Prefix-preserving feeder for iteration-33 bridge intervention replay."""
...
def main():
    ...
    ap.add_argument("--prefix-manifest", default="/model/prefix_manifest_iter33.json")
    ...
    ap.add_argument("--out", default="/model/sentinel_e33_gt.jsonl")
    args = ap.parse_args()
    ...
    for sc in ordered_scenes:
        ...
        for sample_index, smp in enumerate(chain):
            ...
            t0 = time.time()
            post(f"{base}/sentinel_e33_context", context)
