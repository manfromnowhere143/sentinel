#!/usr/bin/env python3
"""Iteration-29 frozen label-atlas and support-bar analysis.
...
COUNT_FLOORS = {
    "fit": {
        "low_diversity_1p5": 240,
        "high_diversity_2p0": 240,
        "danger_4p5": 240,
        "safe_6p0": 240,
        "eligible_lowdiv": 80,
        "benign_control": 160,
    ...
    "calibration": {
        "low_diversity_1p5": 80,
        "high_diversity_2p0": 80,
        "danger_4p5": 80,
        "safe_6p0": 80,
        "eligible_lowdiv": 25,
        "benign_control": 60,
...
MIN_ELIGIBLE_LOWDIV_SCENES = {"fit": 15, "calibration": 5, "heldout": 5}
...
def analyze(args: argparse.Namespace) -> dict:
    ...
    return {
        "stage": "iter29_full_trainval_risk_support_atlas",
        "inputs": {
