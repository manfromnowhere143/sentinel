...
HELPERS = '''
# ---- Sentinel iter15: the union with threat-cleared latch release --------------------------------
# Identical triggers and actuator to the iteration-8 union; ONE new mechanism: after braking, if
# for SENTINEL_RELEASE_K consecutive frames no tracked object fires either union term against the
# planner's CURRENT plan, the latch releases and control returns to the planner (re-arms normally).
