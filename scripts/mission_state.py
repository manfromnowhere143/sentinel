...
def _validate_tooling_publication(
    ...
    *,
    ...
    try:
        ...
        if publication_generation in {3, 4, 5, 6}:
            try:
        ...
        if publication_generation in {5, 6}:
        ...
        if publication_generation in {4, 5, 6}:
        ...
        if len(ancestry) < 2:
            generation_label = {2: "two", 3: "three", 4: "four", 5: "five", 6: "six"}[
