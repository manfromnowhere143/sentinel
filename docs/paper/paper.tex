% ARCHIVED_NOT_SUBMISSION_READY: see STATUS.md before building or distributing this source.
...
\bibitem{neuroncap} W. Ljungbergh, A. Tonderski, J. Johnander, H. Caesar, K. {\AA}str{\"o}m,
M. Felsberg, and C. Petersson. NeuroNCAP: Photorealistic closed-loop safety testing for
autonomous driving. In \emph{European Conference on Computer Vision (ECCV)}, 2024.
DOI:10.1007/978-3-031-73404-5\_10; arXiv:2404.07762.
\bibitem{bevplanner} Z. Li, Z. Yu, S. Lan, J. Li, J. Kautz, T. Lu, and J. M. Alvarez. Is ego
status all you need for open-loop end-to-end autonomous driving? In \emph{IEEE/CVF Conference on
Computer Vision and Pattern Recognition (CVPR)}, 2024. arXiv:2312.03031.
...
\bibitem{dmad} Y. Shen, {\"O}. {\c{S}}. Ta{\c{s}}, K. Wang, R. Wagner, and C. Stiller. Divide and
merge: Motion and semantic learning in end-to-end autonomous driving. In \emph{Advances in Neural
Information Processing Systems (NeurIPS)}, 2025. arXiv:2502.07631.
\bibitem{imagidrive} ImagiDrive: driving-world-model imagination with a VLM agent. ICRA 2026;
arXiv:2508.11428.
\bibitem{catplan} Z. Xiong, S. Liu, N. Helgesen, J. Johnander, and P.-E. Forss{\'e}n. Collision
risk estimation via loss prediction in end-to-end autonomous driving. arXiv:2503.07425, 2025.
(v1 titled ``CATPlan: Loss-based collision prediction in end-to-end autonomous driving''.)
\bibitem{argus} Argus: runtime monitoring and takeover for end-to-end drivers. arXiv:2511.09032,
ASE 2025.
\bibitem{centaur} C. Sima, K. Chitta, Z. Yu, S. Lan, P. Luo, A. Geiger, H. Li, and J. M. Alvarez.
Centaur: Robust end-to-end autonomous driving with test-time training. arXiv:2503.11650, 2025.
\bibitem{diver} Z. Song, L. Liu, H. Pan, B. Liao, M. Guo, L. Yang, Y. Zhang, S. Xu, C. Jia, and
Y. Luo. DIVER: Reinforced diffusion breaks imitation bottlenecks in end-to-end autonomous
driving. arXiv:2507.04049, 2025.
\bibitem{gtrs} Z. Li, W. Yao, Z. Wang, X. Sun, J. Chen, N. Chang, M. Shen, Z. Wu, S. Lan, and
J. M. Alvarez. Generalized trajectory scoring for end-to-end multimodal planning.
arXiv:2506.06664, 2025. 1st place, End-to-End Driving Track, CVPR 2025 Autonomous Grand
Challenge.
\bibitem{diffusiondrive} DiffusionDrive: Truncated diffusion model for end-to-end autonomous
driving. In \emph{IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)}, 2025.
arXiv:2411.15139.
\bibitem{awta} Y. Xu, V. Letzelter, M. Chen, {\'E}. Zablocki, and M. Cord. Annealed
winner-takes-all for motion forecasting. In \emph{IEEE International Conference on Robotics and
Automation (ICRA)}, 2025. arXiv:2409.11172.
\bibitem{modecollapse} M. Hugenholtz, A. Meszaros, J. Kober, and Z. Ajanovic. Mode collapse
happens: Evaluating critical interactions in joint trajectory prediction models.
arXiv:2506.23164, 2025.
